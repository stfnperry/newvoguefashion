...
define( 'KUBERA_VERSION', '1.0.0' );

if ( ! function_exists( 'kubera_setup' ) ) {
	add_action( 'after_setup_theme', 'kubera_setup' );
	/**
	 * Sets up theme defaults and registers support for various WordPress features.
	 *
	 */
	function kubera_setup() {
		// Make theme available for translation.
		load_theme_textdomain( 'kubera' );
		...
		register_nav_menus( array(
			'primary' => __( 'Primary Menu', 'kubera' ),
		) );

		/**
		 * Set the content width to something large
		 * We set a more accurate width in kubera_smart_content_width()
		 */
...
define('KUBERA_THEME_URL','https://wpkoi.com/kubera-wpkoi-wordpress-theme/','kubera');
define('KUBERA_WPKOI_AUTHOR_URL','https://wpkoi.com/','kubera');
define('KUBERA_WPKOI_SOCIAL_URL','https://www.facebook.com/wpkoithemes/','kubera');
define('KUBERA_WORDPRESS_REVIEW','https://wordpress.org/support/theme/kubera/reviews/?filter=5','kubera');
define('KUBERA_DOCUMENTATION','https://wpkoi.com/docs/','kubera');
define('KUBERA_FONT_AWESOME_LINK','https://fontawesome.com/icons','kubera');
