...
$navigation_active = ( 'nav-left-sidebar' == kubera_get_navigation_location() ) ? true : false;
...
?>
<div id="left-sidebar" itemtype="https://schema.org/WPSideBar" itemscope="itemscope" <?php kubera_left_sidebar_class(); ?>>
	<div class="inside-left-sidebar">
		<?php
		/**
		 * kubera_before_left_sidebar_content hook.
		 *
		 */
		do_action( 'kubera_before_left_sidebar_content' );
		...
		/**
		 * kubera_after_left_sidebar_content hook.
		 *
		 */
		do_action( 'kubera_after_left_sidebar_content' );
		?>
