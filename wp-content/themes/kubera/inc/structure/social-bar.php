...
if ( ! function_exists( 'kubera_social_bar' ) ) {
	add_action( 'kubera_social_bar_action', 'kubera_social_bar' );
	function kubera_social_bar() {
		$socials_facebook_url  		=  kubera_get_setting( 'socials_facebook_url' );
		$socials_twitter_url   		=  kubera_get_setting( 'socials_twitter_url' );
		$socials_google_url    		=  kubera_get_setting( 'socials_google_url' );
		$socials_tumblr_url    		=  kubera_get_setting( 'socials_tumblr_url' );
		$socials_pinterest_url 		=  kubera_get_setting( 'socials_pinterest_url' );
		$socials_youtube_url   		=  kubera_get_setting( 'socials_youtube_url' );
		$socials_linkedin_url  		=  kubera_get_setting( 'socials_linkedin_url' );
		$socials_custom_icon_1  	=  kubera_get_setting( 'socials_custom_icon_1' );
		$socials_custom_icon_url_1  =  kubera_get_setting( 'socials_custom_icon_url_1' );
		$socials_custom_icon_2  	=  kubera_get_setting( 'socials_custom_icon_2' );
		$socials_custom_icon_url_2  =  kubera_get_setting( 'socials_custom_icon_url_2' );
		$socials_custom_icon_3  	=  kubera_get_setting( 'socials_custom_icon_3' );
		$socials_custom_icon_url_3  =  kubera_get_setting( 'socials_custom_icon_url_3' );
		$socials_mail_url     		=  kubera_get_setting( 'socials_mail_url' );
	?>
