...
if ( ! function_exists( 'kubera_archive_title' ) ) {
	add_action( 'kubera_archive_title', 'kubera_archive_title' );
	/**
	 * Build the archive title
	 *
	 */
	function kubera_archive_title() { ?>
		<header class="page-header<?php if ( is_author() ) echo ' clearfix';?>">
			<?php
			/**
			 * kubera_before_archive_title hook.
			 *
			 */
			do_action( 'kubera_before_archive_title' );
			?>
			...
			<?php
			/**
			 * kubera_after_archive_title hook.
			 *
			 */
			do_action( 'kubera_after_archive_title' );
			...
			/**
			 * kubera_after_archive_description hook.
			 *
			 */
			do_action( 'kubera_after_archive_description' ); ?>
		</header><!-- .page-header -->
		<?php
	}
}

if ( ! function_exists( 'kubera_filter_the_archive_title' ) ) {
	add_filter( 'get_the_archive_title', 'kubera_filter_the_archive_title' );
	/**
	 ...
	 */
	function kubera_filter_the_archive_title( $title ) {
		if ( is_category() ) {
