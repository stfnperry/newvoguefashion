...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'hentry' ); ?>>
	<?php 
	$page_img_enable = get_theme_mod( 'blog_lover_enable_single_page_featured_img', true );
	...
	<?php 
	$page_author_enable = get_theme_mod( 'blog_lover_enable_single_page_author', false );
